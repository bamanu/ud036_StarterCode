...
_AVATAR = media.Movie("Avatar",
                      ...
                      "wikipedia/sco/b/b0/Avatar-Teaser-Poster.jpg",
                      "https://www.youtube.com/watch?v=5PSNL1qE6VY")


_AMELIE = media.Movie("Amelie",
                      "The story of a girl and the small"
                      " important things in life",
                      "https://upload.wikimedia.org/"
                      "wikipedia/en/5/53/Amelie_poster.jpg",
...
_MIDNIGHT_IN_PARIS = media.Movie("Midnight in Paris",
                                 "Storyline",
                                 "http://t3.gstatic.com/"
                                 "images?q=tbn:ANd9GcTk3ssys2bKM5"
                                 "-U6XMgvoD8yVoS5Io2YKg_1xA6x6GA8mKuuqID",
...
_MOVIES = [_TOY_STORY, _AVATAR, _AMELIE, _RATATOUILLE,
           _MIDNIGHT_IN_PARIS, _HUNGER_GAMES]
